...
* *Working on* - Patch for Liferay 6.0.6
* *18.06.11* - Patch for Liferay 6.0.5 - "liferay-6.0.5-patch.zip":https://github.com/topolik/Extlet6/blob/master/liferay-6.0.5-patch/liferay-6.0.5-patch.zip - please unzip into tomcat/webapps/ROOT directory
* *18.06.11* - "LPS-14221: Ext Plugin Redeploy":http://issues.liferay.com/browse/LPS-14221

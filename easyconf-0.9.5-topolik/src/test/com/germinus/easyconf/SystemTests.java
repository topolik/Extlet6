...
import com.germinus.easyconf.systemtests.ReloadTest;
...
public class SystemTests extends TestCase {
    ...
    private static final Log log = LogFactory.getLog(SystemTests.class);
    ...
    public static TestSuite suite () {
        TestSuite suite = new TestSuite("EasyConf system Tests");
